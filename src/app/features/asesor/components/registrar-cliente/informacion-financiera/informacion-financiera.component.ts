...
export class InformacionFinancieraComponent {
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.form = this.fb.group({
      ingresosMensuales: [null, [Validators.required, Validators.min(0)]],
      egresosMensuales: [null, [Validators.required, Validators.min(0)]],
      totalActivos: [null, [Validators.required, Validators.min(0)]],
      totalPasivos: [null, [Validators.required, Validators.min(0)]],
    });
